...
public class AdminFetchRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_fetch_request);

        Toolbar toolbar = findViewById(R.id.AdminFetchPageToolbar);
    ...
    private void DateFind(String searchDate) {
        ...
        Toast.makeText(AdminFetchRequestActivity.this, "Searching", Toast.LENGTH_SHORT).show();
