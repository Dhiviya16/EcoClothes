...
public class AdminViewPaidDonationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_paid_donations);

        Toolbar toolbar = findViewById(R.id.AdminViewPaidPageToolbar);
    ...
    private void DateFind(String searchDate) {
        ...
        Toast.makeText(AdminViewPaidDonationsActivity.this, "Searching", Toast.LENGTH_SHORT).show();
