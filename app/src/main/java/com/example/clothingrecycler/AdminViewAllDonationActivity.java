...
public class AdminViewAllDonationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_all_donation);

        Toolbar toolbar = findViewById(R.id.AdminViewDonationPageToolbar);
    ...
    private void DateFind(String searchDate) {
        ...
        Toast.makeText(AdminViewAllDonationActivity.this, "Searching", Toast.LENGTH_SHORT).show();
