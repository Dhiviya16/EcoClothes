...
public class AdminCompletedRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.AdminCompletedPageToolbar);
    ...
    private void DateFind(String searchDate) {
        ...
        Toast.makeText(AdminCompletedRequestActivity.this, "Searching", Toast.LENGTH_SHORT).show();
