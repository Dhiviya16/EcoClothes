...
public class AdminViewAllRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_all_request);

        Toolbar toolbar = findViewById(R.id.AdminViewPageToolbar);
    ...
    private void DateFind(String searchDate) {
        ...
        Toast.makeText(AdminViewAllRequestActivity.this, "Searching", Toast.LENGTH_SHORT).show();
