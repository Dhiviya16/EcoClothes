...
public class AdminRejectedRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_rejected_request);

        Toolbar toolbar = findViewById(R.id.AdminRejectedViewPageToolbar);
    ...
    private void DateFind(String searchDate) {
        ...
        Toast.makeText(AdminRejectedRequestActivity.this, "Searching", Toast.LENGTH_SHORT).show();
